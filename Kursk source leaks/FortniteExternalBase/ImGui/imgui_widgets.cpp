...
bool ImGui::Tab(const char* Label, const char* Icon, bool Enabled)
{
    ...
    it_anim->second.a = ImLerp(it_anim->second.a, Enabled ? ImColor(255, 0, 0) : ImColor(255, 0, 0, 0), g.IO.DeltaTime * 10.f);
    it_anim->second.b = ImLerp(it_anim->second.b, hovered ? ImColor(255, 0, 0, 50) : ImColor(255, 0, 0, 0), g.IO.DeltaTime * 10.f);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    it_anim->second.color = ImLerp(it_anim->second.color, *v ? ImColor(255, 0, 0) : ImColor(14, 14, 14), g.IO.DeltaTime * 10.f);
    it_anim->second.b = ImLerp(it_anim->second.b, hovered ? ImColor(255, 0, 0, 50).Value : ImColor(ImGui::GetColorU32(ImGuiCol_Border)).Value, g.IO.DeltaTime * 10.f);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (value > 1)
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(1, 1), frame_bb.Min + ImVec2(it_anim->second.a, grab_bb.Max.y - grab_bb.Min.y + 3), ImColor(255, 0, 0), rounding);
